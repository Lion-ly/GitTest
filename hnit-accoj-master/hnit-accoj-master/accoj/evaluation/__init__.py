...
def evaluate_trend_analysis(company, company_cp):
    ...
    teacher_score_1 = evaluation.get(f"trend_analysis_score").get("first").get("teacher_score")
    teacher_score_2 = evaluation.get(f"trend_analysis_score").get("second").get("teacher_score")
    username = company.get("student_no")
    ...
    scores = {"first" : {"student_score": score1, "teacher_score": teacher_score if not teacher_score_1 or teacher_score_1 == -1 else teacher_score_1},
              "second": {"student_score": score2, "teacher_score": teacher_score if not teacher_score_2 or teacher_score_2 == -1 else teacher_score_2}}
    mongo.db.company.update({"student_no": {"$regex": r"^{}".format(username)}},
...
def evaluate_common_ratio_analysis(company, company_cp):
    ...
    teacher_score = -1
    evaluation = company.get("evaluation")
    teacher_score_1 = evaluation.get("common_ratio_analysis").get("first").get("teacher_score")
    teacher_score_2 = evaluation.get("common_ratio_analysis").get("second").get("teacher_score")
    username = company.get("student_no")
...
def evaluate_ratio_analysis(company, company_cp):
    ...
    teacher_score = -1
    evaluation = company.get("evaluation")
    teacher_score_old = evaluation.get("ratio_analysis").get("teacher_score")
    username = company.get("student_no")
    scores = _statement_func("ratio_analysis", company, company_cp, total_score)
    scores = {"student_score": scores, "teacher_score": teacher_score if not teacher_score_old or teacher_score_old == -1 else teacher_score_old}
    mongo.db.company.update({"student_no": {"$regex": r"^{}".format(username)}},
...
def evaluate_dupont_analysis(company, company_cp):
    ...
    teacher_score = -1
    evaluation = company.get("evaluation")
    teacher_score_old = evaluation.get("dupont_analysis").get("teacher_score")
    username = company.get("student_no")
